...
const HeaderPokeball404 = () => {
  ...
  const handleChangeDarkMode = () => {
    if (document.documentElement.classList.contains("dark")) {
      ...
      setEventsDark404(false);
      setEventIcono404(<i className="bx bx-moon  text-blue-400 text-[25px] sm:text-3xl "></i>);
    } else {
      document.documentElement.classList.add("dark");
      localStorage.setItem("dark", true);
      setEventsDark404(true);
      setEventIcono404(<i className="bx bx-sun  text-yellow-400 text-[25px] sm:text-3xl "></i>);
    }
  };
